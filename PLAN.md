...
- **Brand marks**: GitHub and LinkedIn use their official marks (paths from Simple Icons, `src/ui/brandPaths.ts`), only as links to Mohith's profiles, as both brands' guidelines allow.
